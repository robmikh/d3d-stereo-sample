...
BasicShapes::BasicShapes(ID3D11Device* d3dDevice)
{
...
)
{
    *vertexBuffer = nullptr;
    winrt::com_ptr<ID3D11Buffer> vertexBufferInternal;
...
{
    *indexBuffer = nullptr;
    winrt::com_ptr<ID3D11Buffer> indexBufferInternal;
